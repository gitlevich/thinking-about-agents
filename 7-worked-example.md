...
I — I mean, Meta-agent, made an executive decision to cut it and switched my attention into the mode of an observer,
floating through beautiful space, real space, as seen with my eyes — the world, the entire sensorium, along all of the
contrasts I watch at the moment.
...
So that’s how I think. Now I’ve been pulled back by the Meta-agent, the gatekeeper — the regulator — a simple meta-agent I
